        ...
        <section className="py-20 md:py-32 px-4 md:px-8 lg:px-12 bg-lavender">
            <div className="max-w-6xl mx-auto">
                <div className="mb-16 text-center">
                    <h2 className="text-4xl md:text-5xl font-bold text-[#485b51] mb-8 tracking-tight">Welcome to Tooth Story – Dental Clinic For All</h2>
                ...
                <div className="bg-white p-10 md:p-16 rounded-[32px] shadow-premium border border-white/50 mb-16 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-3xl md:text-4xl font-bold text-[#485b51] mb-8 tracking-tight">Advanced Orthodontics & Kids Dental Care</h3>
